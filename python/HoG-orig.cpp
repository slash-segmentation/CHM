...
#ifdef _MSC_VER
#pragma warning( push )
#pragma warning( disable : 4305 ) // 'initializing' : truncation from 'double' to '_____'
								  // '_' : conversion from 'double' to 'float', possible loss of data
#pragma warning( disable : 4244 ) // 'initializing' : conversion from 'double' to 'int', possible loss of data
#pragma warning( disable : 4018 ) // '_' : signed/unsigned mismatch
#else
